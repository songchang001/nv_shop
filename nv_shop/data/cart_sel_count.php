<?php
    ...
    if($output['count']==0){
        ...
        $sql = "SELECT pname,price,pic_s,count,pid,did FROM nv_product,nv_cart_details WHERE nv_cart_details.productId=nv_product.pid AND nv_cart_details.cartId=$ctid";
        $result = mysqli_query($conn,$sql);
